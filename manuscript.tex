...
\begin{MyShadequote}
  ...
  On the other hand, in electronic music, one can either compose each sound directly in terms of its wave succession, of, finally, each individual sound wave may be determined in terms of its actual vibration, by and ordering of the succession of pulses (p. 41).
\end{MyShadequote}
